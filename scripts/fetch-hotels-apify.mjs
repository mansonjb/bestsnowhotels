...
const TARGETS = [
  ...
  // Spain / Andorra / Latin America wave (town-aware where lodging really is)
  { slug: 'sierra-nevada', query: 'hoteles Pradollano Sierra Nevada Granada Spain', maxDist: 9000, minReviews: 30 },
  { slug: 'alto-campoo', query: 'hoteles Reinosa Cantabria Spain', maxDist: 30000, minReviews: 12 },
  ...
  { slug: 'roccaraso', query: 'hotel Roccaraso Aremogna Rivisondoli Abruzzo Italia', maxDist: 12000, minReviews: 15 },
  { slug: 'appi-kogen', query: 'Appi Kogen resort hotel Hachimantai Iwate Japan', maxDist: 16000, minReviews: 8 },
  ...
  { slug: 'port-aine', query: 'hoteles Rialp Sort Port Aine Lleida Espana', maxDist: 22000, minReviews: 6 },
  { slug: 'vallter-2000', query: 'hoteles Setcases Camprodon Vall de Camprodon Espana', maxDist: 25000, minReviews: 6 },
  { slug: 'la-pierre-saint-martin', query: 'hotels Arette La Pierre Saint-Martin Pyrenees France', maxDist: 25000, minReviews: 5 },
  { slug: 'la-norma', query: 'hotels Modane Maurienne Savoie France', maxDist: 12000, minReviews: 6 },
  { slug: 'crevoux', query: 'hotels Embrun Crevoux Hautes-Alpes France', maxDist: 25000, minReviews: 6 },
  { slug: 'alagna', query: 'hotels Alagna Valsesia Italy', maxDist: 12000, minReviews: 6 },
  { slug: 'spitzingsee', query: 'hotels Schliersee Spitzingsee Bayern Germany', maxDist: 15000, minReviews: 12 },
  { slug: 'riedberg', query: 'hotels Balderschwang Obermaiselstein Allgau Germany', maxDist: 18000, minReviews: 8 },
  { slug: 'moelltaler-gletscher', query: 'hotels Flattach Molltal Karnten Austria', maxDist: 22000, minReviews: 6 },
  { slug: 'kvitfjell', query: 'hotels Favang Ringebu Kvitfjell Norway', maxDist: 25000, minReviews: 5 },
  { slug: 'skeikampen', query: 'hotels Gausdal Skeikampen Norway', maxDist: 25000, minReviews: 5 },
  { slug: 'lofsdalen', query: 'hotels Lofsdalen Harjedalen Sweden', maxDist: 16000, minReviews: 4 },
  { slug: 'branas', query: 'hotels Branas Syssleback Varmland Sweden', maxDist: 22000, minReviews: 4 },
  { slug: 'saariselka', query: 'hotels Saariselka Inari Lapland Finland', maxDist: 12000, minReviews: 8 },
  { slug: 'tomamu', query: 'Hoshino Resorts Tomamu hotel Shimukappu Hokkaido Japan', maxDist: 9000, minReviews: 15 },
  { slug: 'vivaldi-park', query: 'Sono Belle Vivaldi Park hotel Hongcheon South Korea', maxDist: 12000, minReviews: 12 },
  { slug: 'eden-valley', query: 'Eden Valley ski resort hotel Yangsan South Korea', maxDist: 18000, minReviews: 6 },
  { slug: 'marmot-basin', query: 'hotels Jasper Alberta Canada', maxDist: 25000, minReviews: 40 },
  { slug: 'banff-sunshine', query: 'hotels Banff Alberta Canada', maxDist: 25000, minReviews: 60 },

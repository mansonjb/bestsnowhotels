...
export const SH_SECTIONS: ShSection[] = [
  {
    ...
    mapZoom: 10,
    name: { en: "Chile", fr: "Chili", es: "Chile", pt: "Chile", it: "Cile", nl: "Chili" },
    blurb: {
  ...
  },
  {
    ...
    mapZoom: 10,
    name: { en: "Argentina", fr: "Argentine", es: "Argentina", pt: "Argentina", it: "Argentina", nl: "Argentinië" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'queenstown',
    mapZoom: 10,
    name: { en: "New Zealand", fr: "Nouvelle-Zélande", es: "Nueva Zelanda", pt: "Nova Zelândia", it: "Nuova Zelanda", nl: "Nieuw-Zeeland" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'thredbo',
    mapZoom: 10,
    name: { en: "Australia", fr: "Australie", es: "Australia", pt: "Austrália", it: "Australia", nl: "Australië" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'afriski',
    mapZoom: 9,
    name: { en: "Southern Africa", fr: "Afrique australe", es: "África austral", pt: "África Austral", it: "Africa australe", nl: "Zuidelijk Afrika" },
    blurb: {
...
export const SH_COPY = {
  ...
  months: [
    {
      tag: { en: "June", fr: "Juin", es: "Junio", pt: "Junho", it: "Giugno", nl: "Juni" },
      body: {
    ...
    {
      tag: { en: "July to August", fr: "Juillet à août", es: "Julio a agosto", pt: "Julho a agosto", it: "Luglio e agosto", nl: "Juli tot augustus" },
      body: {
    ...
    {
      tag: { en: "September to October", fr: "Septembre à octobre", es: "Septiembre a octubre", pt: "Setembro a outubro", it: "Settembre e ottobre", nl: "September tot oktober" },
      body: {

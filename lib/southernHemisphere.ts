...
export const SH_SECTIONS: ShSection[] = [
  {
    ...
    mapZoom: 10,
    name: { en: "Chile", fr: "Chili", es: "Chile", pt: "Chile", it: "Cile", ja: "チリ", nl: "Chili" },
    blurb: {
  ...
  },
  {
    ...
    mapZoom: 10,
    name: { en: "Argentina", fr: "Argentine", es: "Argentina", pt: "Argentina", it: "Argentina", ja: "アルゼンチン", nl: "Argentinië" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'queenstown',
    mapZoom: 10,
    name: { en: "New Zealand", fr: "Nouvelle-Zélande", es: "Nueva Zelanda", pt: "Nova Zelândia", it: "Nuova Zelanda", ja: "ニュージーランド", nl: "Nieuw-Zeeland" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'thredbo',
    mapZoom: 10,
    name: { en: "Australia", fr: "Australie", es: "Australia", pt: "Austrália", it: "Australia", ja: "オーストラリア", nl: "Australië" },
    blurb: {
  ...
  },
  {
    ...
    mapSlug: 'afriski',
    mapZoom: 9,
    name: { en: "Southern Africa", fr: "Afrique australe", es: "África austral", pt: "África Austral", it: "Africa australe", ja: "南部アフリカ", nl: "Zuidelijk Afrika" },
    blurb: {
...
export const SH_COPY = {
  ...
  months: [
    {
      tag: { en: "June", fr: "Juin", es: "Junio", pt: "Junho", it: "Giugno", ja: "6月", nl: "Juni" },
      body: {
    ...
    {
      tag: { en: "July to August", fr: "Juillet à août", es: "Julio a agosto", pt: "Julho a agosto", it: "Luglio e agosto", ja: "7月〜8月", nl: "Juli tot augustus" },
      body: {
    ...
    {
      tag: { en: "September to October", fr: "Septembre à octobre", es: "Septiembre a octubre", pt: "Setembro a outubro", it: "Settembre e ottobre", ja: "9月〜10月", nl: "September tot oktober" },
      body: {

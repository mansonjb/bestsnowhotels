...
export const BEST_FOR_LISTS: BestForList[] = [
  {
    ...
    intro: {
      ...
      'zh-hk': "最有機會帶來真材實料積雪的阿爾卑斯山脈和比利牛斯山脈滑雪場，依我們0至100分的積雪指數，以及高海拔資歷精選而成。",
    ...
    description: {
      ...
      'zh-hk': "積雪才是滑雪之旅的重點，這些滑雪場憑藉海拔和朝向，比其他地方更能穩定地帶來積雪。我們按積雪指數排名，這是結合山麓與山頂海拔、歷年積雪紀錄及朝向的0至100分指標。這裡的滑雪場通常較早開放、較遲關閉，即使海拔較低的鄰近滑雪場在雪量不足的冬季提早收山，它們依然撐得住。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "寬闊平緩的雪道、禁止車輛進入的村莊，加上專屬兒童區：這些滑雪場同時照顧到父母與孩子的需要。",
    ...
    description: {
      ...
      'zh-hk': "出色的家庭滑雪場不只需要一個好的兒童俱樂部：還要有平緩的坡度、纜車直達的初學者專區、可以安心散步的村莊，以及下雪天充足的室內備案。這些滑雪場一一做到，從禁止汽車進入的Wengen、擁有地下小火車的Serfaus-Fiss-Ladis，到緊貼雪道的Avoriaz。它們依然是貨真價實的高山，但首先考慮的是孩子。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "阿爾卑斯山脈和比利牛斯山脈中最精緻的高端下榻之選，米芝蓮星級餐廳和ski-in禮賓服務都是基本配備。",
    ...
    description: {
      ...
      'zh-hk': "溫馨、私密，又或是徹頭徹尾的浮華耀目，這些滑雪場的大街看起來更像Bond Street，而山莊裡的浴室大得跟睡房差不多。從法國的Courchevel和Megève，到瑞士的Gstaad、Zermatt和St. Moritz，再到意大利的Cortina，生活方式和壓雪品質同樣經過精心雕琢。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "美國最耀眼的山頭，五星級酒店、滑雪裝備代泊服務和世界級美食，在這裡與洛磯山脈和Wasatch山脈乾燥深厚的積雪相遇。",
    ...
    description: {
      ...
      'zh-hk': "這是美國滑雪的頂端。Aspen和Vail以設計師精品店、私人會所和緊貼雪道的五星級酒店定下基調；Beaver Creek在山腳以熱曲奇迎接旅客；Deer Valley則禁止滑雪板、限制每日纜車票數量，令雪道保持空曠而平整。再加上Telluride峽谷地形的魅力、Park City的Main Street歷史風貌，以及Sun Valley和Stowe那種老派豪門的優雅氣質，這些滑雪場的纜車，是真正從套房門口就開始。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "全年或秋季就開放冰川滑雪的滑雪場，即使阿爾卑斯山脈其他地方已經無雪可滑，這裡依然持續有雪。",
    ...
    description: {
      ...
      'zh-hk': "當冰川是滑雪區的一部分，雪季會更長、積雪更可靠，而且不論天氣如何，通常都能找到幾條雪道可滑。從全年365日開放、廣為人知的Hintertux，到Tignes、Saas-Fee、Les Deux Alpes、Kitzsteinhorn和Stubai，這些滑雪場的重活，都是由高海拔的冰川來扛。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "按纜車覆蓋的雪道公里數計算，歐洲相連範圍最大的滑雪區，適合想每天都滑不同雪道的滑雪愛好者。",
    ...
    description: {
      ...
      'zh-hk': "這些滑雪場規模驚人：每個都能憑一張纜車票，連接200公里或以上的雪道，從龐大的Trois Vallées和Paradiski，到橫跨國境的Portes du Soleil，再到意大利的Dolomiti Superski。在這裡待一星期，也只是略窺全貌，即使滑到第7天，還是能找到一條你未試過的雪道。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "大山，卻是親民價格：這裡的纜車票、酒店和午餐，都比熱門大名滑雪場便宜。",
    ...
    description: {
      ...
      'zh-hk': "在阿爾卑斯山脈滑雪，不一定要付Courchevel那種價錢。這些滑雪場，從意大利的Bormio和Sauze d'Oulx，到西班牙一側的比利牛斯山脈，再到法國南阿爾卑斯山區，都能以明顯親民得多的價格，提供貨真價實的高山滑雪體驗。同樣的積雪，帳單卻少一半。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "野雪才是重點：纜車可達的野雪雪道、廣闊地形，加上與之匹配的滑雪文化。",
    ...
    description: {
      ...
      'zh-hk': "自由滑雪意味著拋開壓雪雪道，這些滑雪場正是為此而生：朝北的坡面、漫長的野雪雪道、便捷的直升機接送，以及嚴謹的安全文化。從傳奇般的Engelberg和Alagna，到Sainte-Foy、Ordino-Arcalís和Fieberbrunn，這裡是粉雪愛好者最先訂下假期的地方。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "擁有最大初學者專區和最平緩坡度的滑雪場，讓初次滑雪的人能安心站穩腳步。",
    ...
    description: {
      ...
      'zh-hk': "學滑雪跟悠閒地滑藍道，是完全不同的兩回事，選對滑雪場很重要：專屬的初學者緩坡、魔毯輸送帶、友善的滑雪學校，以及輕鬆可達的長緩雪道。這些滑雪場全部具備，而我們的精選特別青睞法國、西班牙和安道爾的滑雪區，那裡標示清晰的綠道系統，能為初學者提供容易判讀的安全地形。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "村莊本身就座落於高處：阿爾卑斯山脈和比利牛斯山脈中，山麓海拔最高的滑雪場。",
    ...
    description: {
      ...
      'zh-hk': "村莊海拔高，是你能買到最簡單的積雪保險。這些滑雪場的住宿本身已在海拔1800米或以上，因此即使在雪量不足的冬季，家門口的積雪幾乎總是靠得住，從海拔2300米的Val Thorens，到Tignes、Val d'Isère、Avoriaz和Kühtai都是如此。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "村莊本身禁止汽車進入的滑雪場，改以馬拉雪橇和電動計程車代步。",
    ...
    description: {
      ...
      'zh-hk': "禁止汽車的村莊，是滑雪運動裡數一數二寧靜的奢侈享受，耳邊只有馬蹄聲和雪板滑過積雪的聲音。從瑞士的Zermatt、Wengen和Mürren，到法國的Avoriaz和Vaujany，這些滑雪場都讓你把車留在山谷，改由火車、纜車或雪橇送你上山。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "擁有歐洲最大、造型最出色雪上樂園的滑雪場，獻給為了跳台而來的滑雪和滑雪板愛好者。",
    ...
    description: {
      ...
      'zh-hk': "這些滑雪場把雪上樂園當成主打賣點，而非附屬設施。瑞士的Laax為樂園造型立下標杆；Mayrhofen、Saalbach、Livigno、Madonna di Campiglio、Avoriaz和Grandvalira則緊隨其後。這裡有多條樂園路線、定期舉辦的比賽、專責的地形維護團隊，以及與之匹配的樂園後社交文化。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "距日內瓦機場約2小時車程以內的滑雪場，非常適合長週末或一趟航班就能成行的滑雪假期。",
    ...
    description: {
      ...
      'zh-hk': "日內瓦座落於歐洲滑雪場最密集的區域中心，東面是法國北阿爾卑斯山區，南面是Portes du Soleil，北面和東面則是瑞士Vaud和Valais州的滑雪場。從Megève和Chamonix，到Avoriaz、Verbier和Crans-Montana，這是一份你能在距離市中心約200公里範圍內抵達的精選滑雪場名單，按積雪可靠度排序。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': '從里昂出發的法國阿爾卑斯山區：適合長週末自駕前往的滑雪場，按積雪可靠度和滑雪區規模精選。',
    ...
    description: {
      ...
      'zh-hk': "里昂是通往Tarentaise和Maurienne兩大巨頭滑雪區的天然門戶，法國南阿爾卑斯山區也輕鬆可達。從Isère省的Alpe d'Huez和Les Deux Alpes，到更東面的Val Thorens、Tignes和Les Arcs，這些滑雪場都在距離市中心約250公里範圍內，按積雪指數排名。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': '從慕尼黑出發的奧地利阿爾卑斯山區：適合週末輕鬆前往的滑雪樂園、派對勝地和Tirol式暢滑路線，積雪穩定可靠。',
    ...
    description: {
      ...
      'zh-hk': "慕尼黑距離Tirol核心地帶僅數小時車程，前往Salzburg和Salzburger Land地區也是短短一段車程。Kitzbühel、Sölden、Ischgl、Zillertal谷地的Mayrhofen、Hintertux和Gerlos，加上Stubai冰川和Kühtai，全部座落於距離市中心300公里範圍之內。積雪穩定可靠，滑雪後派對聲浪十足，效率之高也是出了名的。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': '從巴塞隆拿短途車程可達的西班牙、安道爾和加泰隆尼亞一側比利牛斯山脈，全都在陽光眷顧的向陽一面。',
    ...
    description: {
      ...
      'zh-hk': "巴塞隆拿是前往比利牛斯山脈南側最方便的大城市據點：安道爾的Baqueira-Beret、Grandvalira和Vallnord，加泰隆尼亞一側的La Molina和Masella，再加上更西面幾個規模較小的阿拉貢滑雪場。在距離市中心300公里範圍內，你可以在西班牙雪道追逐遲來的陽光，或是跨境到安道爾喝免稅啤酒，一個週末就能全部體驗。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "Japow源源不絕：北海道加本州的滑雪場，撐起日本粉雪美譽的根基，按積雪指數排名。",
    ...
    description: {
      ...
      'zh-hk': "從西伯利亞南下、橫越日本海的氣團，在12月至3月期間為北海道和日本阿爾卑斯山脈帶來全球最乾、最厚的積雪。這12個滑雪場涵蓋Niseko和Kiroro的粉雪盆地、Rusutsu和Furano的樹林滑雪、Nozawa、Myoko和Zao等歷史悠久的溫泉滑雪小鎮，以及Hakuba的奧運場地。加上旅館住宿、每天結束後的溫泉浸浴，以及阿爾卑斯山脈也比不上的服務水準。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': '這些日本滑雪場，每年冬天都當之無愧擁有japow美譽：驚人的降雪量、輕盈乾爽的雪花，還有專為此而生的樹林。',
    ...
    description: {
      ...
      'zh-hk': "北海道的Niseko、Rusutsu、Kiroro和Furano承接最豐厚的降雪，年降雪量達14至21米，雪層底部幾乎不會結冰。本州則有Myoko Akakura加持，這裡每年降雪13米，座落於傳統溫泉小鎮地形之中。我們按積雪指數、japow氛圍和樹林滑雪傳統挑選：日出前吃過粉雪日早餐，然後穿越白樺林間的纜椅，一路滑到收纜為止。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "美國滑雪的皇冠明珠，橫跨洛磯山脈、Wasatch山脈、Sierra Nevada山脈、Tetons山脈和東岸：20個按積雪和地形排名的滑雪場。",
    ...
    description: {
      ...
      'zh-hk': "美國擁有全球最大的滑雪市場，多樣性正是重點所在：科羅拉多州高海拔的洛磯山脈（Vail、Aspen、Breckenridge、Telluride、Steamboat）、猶他州飽受粉雪洗禮的Wasatch山脈（Snowbird、Alta、Park City）、加州的Sierra Nevada山脈（Mammoth、Palisades Tahoe、Heavenly）、Jackson Hole和Big Sky狂野的高手級地形，以及東岸Stowe和Killington粗獷的魅力。再加上Sun Valley的復古風情、Taos的沙漠粉雪和Whitefish的高性價比，為這個雪季畫上完滿句號。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "北美滑雪愛好者追逐真材實料的地方：美國本土48州中，降雪量最高、界內地形最陡峭的滑雪場。",
    ...
    description: {
      ...
      'zh-hk': "猶他州的Little Cottonwood Canyon，每年為Snowbird和Alta帶來14米以上的積雪，是美國本土48州中最多雪的兩座山。Jackson Hole則把同樣的氣流，轉化成高手級雪道。Steamboat的Champagne Powder香檳粉雪、Big Sky的Lone Peak、Whitefish的Big Mountain、Mammoth的東Sierra風暴，以及Taos的高地沙漠降雪，共同構成這份名單。這些滑雪場值得你專程規劃一趟粉雪之旅，而不只是路過參觀。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "科羅拉多的經典之選：從Vail和Aspen到Telluride、Breckenridge和Steamboat的高海拔洛磯山脈滑雪，從Denver或Eagle都能輕鬆抵達。",
    ...
    description: {
      ...
      'zh-hk': "科羅拉多州集中了全美最多招牌滑雪場，全部座落於一個州內，山麓海拔都在2,100米以上。Vail以7個Back Bowls後山碗地形和巴伐利亞風格的半山村莊領軍；Aspen Snowmass在山腳延伸出四座山峰和一個老派豪門小鎮；Breckenridge擁有全美界內海拔最高的纜車；Telluride藏身全國地勢最戲劇化的峽谷之中；Beaver Creek把奢華感打磨得淋漓盡致；Steamboat則帶來牧場小鎮風情和Champagne Powder香檳粉雪。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "車牌上都寫著「地球上最好的雪」：Snowbird、Alta、Park City和Deer Valley，全部在Salt Lake City機場45分鐘車程範圍內。",
    ...
    description: {
      ...
      'zh-hk': "Salt Lake City上方的Wasatch山脈，擁有北美最輕盈、最乾爽的積雪之一，並匯聚在幾個峽谷盡頭的滑雪場中。Little Cottonwood Canyon的Snowbird和Alta是粉雪界的皇族；Park City Mountain按可滑雪面積計算是全美最大的滑雪場；Deer Valley則堅持純滑雪、白桌布式的高格調路線。從下機到坐上第一班纜椅：不用兩小時。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "新英格蘭滑雪之鄉，這項運動在1930年代於此萌芽：從Boston、New York或Montréal開車可達的經典佛蒙特州滑雪場。",
    ...
    description: {
      ...
      'zh-hk': "東岸滑雪自成一派：風暴對上時是輕盈的冷粉雪，對不上時就是冰甲般堅硬的壓雪道，還有一群不論哪種雪況都堅持滑下去的硬派本地人文化。Mt Mansfield山下的Stowe，是佛蒙特州最精緻的經典之選；Killington人稱「東岸猛獸」，是本區規模最大、雪季最長的滑雪場。兩者都能讓你從Boston、New York或Montréal出發，一個週末就能成行。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "沒錯，非洲也能滑雪：摩洛哥的亞特拉斯山脈、阿爾及利亞的Djurdjura、萊索托的Maluti山脈、南非的Drakensberg山脈，甚至開羅還有一個室內雪道。",
    ...
    description: {
      ...
      'zh-hk': "非洲的滑雪季節短、雪況常不穩定，規模幾乎總是很小。這正是它的魅力所在。摩洛哥高亞特拉斯山脈的Oukaïmeden是頭牌，海拔2620米，設有7條纜車，以Mt Toubkal為背景；Mischliffen和幾個中亞特拉斯山脈的滑雪場，則在Ifrane附近增添雪松林滑雪體驗。阿爾及利亞經營著Blida上方的Chréa，以及Djurdjura山區的Tikjda和Tala-Guilef雙雄。萊索托的Afriski，是非洲海拔最高的滑雪基地（3050米），南半球雪季為6月至8月，南非的Tiffindell也加入陣容。開羅的Ski Egypt則是室內雪道，全年開放。這裡沒有一處是阿爾卑斯山脈，但每一處都以最精彩的方式，顯得不可思議。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "Whistler太平洋海洋型巨頭、Banff國家公園三雄、Kicking Horse和Revelstoke的高山陡坡，再加上東岸的Tremblant和Mont-Sainte-Anne：10個滑雪場，勾勒出加拿大滑雪的全貌。",
    ...
    description: {
      ...
      'zh-hk': "加拿大用一本護照，裝下兩個滑雪國度。西部以大範圍的海洋型加大陸型氣候運作：太平洋岸有搭載Peak 2 Peak纜車的Whistler Blackcomb、Banff公園三雄（Sunshine加Lake Louise加Marmot Basin）憑海拔和國家公園景致取勝、BC Interior內陸地區的Big White和Sun Peaks提供適合家庭的粉雪、Revelstoke擁有北美最大垂直落差、Kicking Horse則是加拿大界內最陡峭的地形。東部則更冷、規模更小：Tremblant的行人專用村莊距Montreal僅2小時車程，Mont-Sainte-Anne眺望St-Lawrence河的景色距Quebec City僅30分鐘車程。兩岸的雪季都是11月至5月。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': '平昌2018年奧運遺產，加上首爾一日遊滑雪場，以及南部的一個異數：10個排名滑雪去處，勾勒出韓國冬天的全貌。',
    ...
    description: {
      ...
      'zh-hk': "韓國的滑雪版圖，由江原道主導，平昌正是2018年奧運的主辦地。Yongpyong主辦高山滑雪的迴轉和大迴轉項目，Phoenix Pyeongchang主辦自由式滑雪和滑雪板項目，Alpensia則主辦跳台、北歐兩項和雪橇項目。旌善的High1，是老少咸宜的大眾化滑雪場巨頭。離首爾較近的Vivaldi Park、Konjiam和Oak Valley，靠體育場級燈光下的夜間滑雪，吸引大批一日遊旅客，Welli Hilli Park則座落其間。再往南，Muju Deogyusan藏著韓國滑雪可達的最高峰，海拔1614米，而釜山上方的Eden Valley則以全國最南端滑雪場的身份，為名單畫上句號。人工造雪強勁，纜車運作到深夜，KTX高鐵直達門口。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "Snowy Mountains和維多利亞州阿爾卑斯山區：5個滑雪場，勾勒出澳洲滑雪的全貌，南半球雪季為6月至9月。",
    ...
    description: {
      ...
      'zh-hk': "New South Wales州的Perisher，擁有南半球最大的纜車陣容（47條纜車，橫跨4個相連村莊）。Thredbo則在Mt Kosciuszko山下，擁有澳洲最大垂直落差（672米）。維多利亞州阿爾卑斯山區還有Falls Creek（無車行人村莊，北歐式滑雪實力強勁）、Mt Hotham（人稱「澳洲粉雪之都」，可直接滑回村莊）和Mt Buller（離Melbourne最近的大型滑雪場，擁有80公里雪道）。雪桉樹林賦予每條雪道獨一無二的個性，北半球絕無僅有。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "South Island的南阿爾卑斯山脈：5個座落於Wanaka、Queenstown和Methven上方的滑雪場，南半球雪季為6月至10月，山上沒有住宿。",
    ...
    description: {
      ...
      'zh-hk': "Wanaka周邊，Cardrona是老少咸宜的自由式滑雪經典之選，Treble Cone則是高手級自由滑雪的聖地。Queenstown周邊，Coronet Peak有探照燈下的夜間滑雪，The Remarkables則以Lake Wakatipu上方嶙峋的Single Cone山峰命名。South Island再往北，Methven上方的Mt Hutt擁有紐西蘭商業雪季中最長的一個（6月至10月底）。幾乎沒有滑雪場提供ski-in/ski-out住宿：你得睡在湖畔小鎮，每天開車上山。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "Santiago周邊的安第斯山脈：3個經典滑雪場，勾勒出智利滑雪的全貌，Laguna del Inca湖畔的Portillo，以及Tres Valles滑雪群中的Valle Nevado和La Parva，南半球雪季為6月至10月。",
    ...
    description: {
      ...
      'zh-hk': "智利3個經典的安第斯滑雪場，各自呈現南美滑雪的不同面貌。Portillo（Santiago以北2小時車程，山麓海拔2880米）曾主辦南半球唯一一屆高山滑雪世界錦標賽（1966年），至今每年8月仍是美國、加拿大和歐洲國家隊的集訓基地，Laguna del Inca湖畔那座標誌性的黃色Hotel Portillo酒店就是明證。Valle Nevado（Santiago以東1小時30分鐘車程，山麓海拔3025米，全智利最高）採用Compagnie des Alpes的現代化設計，並透過Three Valleys纜車系統連接El Colorado和La Parva。La Parva（同屬Tres Valles）則更具住宅區氣息、更寧靜，擁有Las Lomas高山碗地形，以及需要健行前往的Falsa Parva自由滑雪區。南半球雪季為6月至10月。主角是安第斯山脈，Santiago只是山下1至3小時車程的門戶城市。",
  ...
  },
  {
    ...
    intro: {
      ...
      'zh-hk': "從Patagonia的湖區，到Mendoza的安第斯高地，再到最南端的Tierra del Fuego：阿根廷滑雪精選，南半球雪季為6月至10月。",
    ...
    description: {
      ...
      'zh-hk': "阿根廷的滑雪版圖，沿著安第斯山脈由北到南展開。Bariloche和Lago Nahuel Huapi上方的Cerro Catedral，是南美洲最大的滑雪區，纜車可達的地形穿越lenga南極山毛櫸林，山腳一帶氣氛熱鬧。Mendoza高地的Las Leñas，是全大陸陡峭、積雪可靠的野雪代表，靠Marte纜椅可達，周圍建有一座貨真價實的緊貼雪道山腳村莊。Chapelco（San Martin de los Andes上方）和Cerro Bayo（Villa La Angostura上方），則是Patagonia湖區風景優美、老少咸宜的滑雪場。更南端、Ushuaia附近的Cerro Castor，是地球上最南端的滑雪場，雪季長度數一數二。南半球雪季為6月至10月。",

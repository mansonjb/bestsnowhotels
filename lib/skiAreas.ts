...
export const SKI_AREAS: SkiArea[] = [
  {
    ...
    countryCodes: ['FR'],
    flags: ['🇫🇷'],
    members: ['val-thorens', 'orelle', 'courchevel', 'la-tania', 'meribel', 'les-menuires', 'saint-martin-de-belleville', 'brides-les-bains'],
    lat: 45.35,
    lng: 6.58,
    zoom: 11,
    pistesKm: 600,
    ...
    intro: {
      ...
      ja: "世界最大の連結スキー場。600kmのゲレンデと8つのスキー場をリフト券1枚でカバーし、Tarentaiseの高みにそびえる。",
      'zh-hk': "世界最大的相連滑雪場：600km雪道及八個滑雪場共用一張滑雪證，高踞Tarentaise之上。",
    ...
    description: {
      ...
      ja: "Les 3 Vallées はCourchevel、Méribel、Val Thorens、Les Menuiresとその周辺のスキー場を結び、約160基のリフトが支える600kmの広大な遊び場を作り上げる。そのほとんどが標高1800m以上にある。フランスにおけるビッグマウンテンスキーの基準であり、あらゆるレベルに対応するゲレンデと標高のおかげで長持ちする積雪を備える。1枚のリフト券で当サイト掲載の4つのスキー場をカバーするので、どこを拠点にしても全体を滑ることができる。",
      'zh-hk': "Les 3 Vallées將Courchevel、Méribel、Val Thorens及Les Menuires連同周邊小鎮連成一體，形成一個由約160座纜車服務、廣達600km的滑雪樂園，幾乎全部位於海拔1800m以上。這裡是法國大型雪山滑雪的標竿，各程度雪道齊備，加上海拔優勢令積雪持久。一張滑雪證覆蓋本站介紹的四個滑雪場，隨便選一處落腳都可以滑遍全場。",
  ...
  },
  {
    ...
    countryCodes: ['FR'],
    flags: ['🇫🇷'],
    members: ['les-arcs', 'la-plagne', 'montchavin', 'peisey-vallandry', 'champagny-en-vanoise'],
    lat: 45.55,
    lng: 6.77,
    zoom: 11,
    pistesKm: 425,
    ...
    intro: {
      ...
      ja: "Les ArcsとLa Plagneを2階建てロープウェイVanoise Expressが結び、1枚のリフト券で425kmを楽しめる。",
      'zh-hk': "Les Arcs與La Plagne由雙層纜車Vanoise Express相連，一張滑雪證暢滑425km。",
    ...
    description: {
      ...
      ja: "Paradiskiは世界最大級のロープウェイVanoise ExpressでPonturin谷を越えてLes ArcsとLa Plagneを結び、標高3250mのBellecôte氷河を頂点とする425kmのゲレンデを持つ。標高の高い積雪の安定したスキーと、ゲレンデ直結の豊富な宿泊施設を兼ね備える。どちらのスキー場を拠点にしても、ロープウェイに乗るだけでエリア全体にアクセスできる。",
      'zh-hk': "Paradiski憑藉全球最大纜車之一的Vanoise Express，跨越Ponturin山谷將Les Arcs與La Plagne連接起來，形成425km雪道，最高點直達海拔3250m的Bellecôte冰川。這裡集高海拔、積雪穩定的滑雪體驗與大量近雪道住宿於一身。無論落腳Les Arcs或La Plagne，搭一程纜車即可暢遊全場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "TignesとVal d'Isèreが一体となった、標高が高く積雪の安定した300kmのゲレンデ。ひと世代にわたりEspace Killyの名で親しまれてきた。",
      'zh-hk': "Tignes與Val d'Isère合體，300km高海拔、積雪穩定的雪道，一整代滑雪迷都稱之為Espace Killy。",
    ...
    description: {
      ...
      ja: "Espace KillyはTignesとVal d'Isèreを結び、標高3456mのGrande Motte氷河を頂点とする、ほとんどが高標高にある300kmのゲレンデを形成する。そのためシーズンの長さはアルプスの中でもほぼ随一だ。本格的なスキーヤー向けのエリアで、標高差、オフピステ、安定した積雪が魅力。どちらのスキー場に滞在しても、リフトが途切れることなく両エリアをつないでくれる。",
      'zh-hk': "Espace Killy將Tignes與Val d'Isère連成一體，形成300km大多位於高海拔的雪道，最高點直達海拔3456m的Grande Motte冰川，因此這裡的雪季比阿爾卑斯山幾乎所有地方都長。這是屬於認真滑雪客的滑雪場，落差大、野雪多、積雪穩定可靠。無論住在哪一邊，纜車都能無縫接駁往返兩地。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "世界最大級の国際的スキー場のひとつ。フランスとスイスにまたがる十数の村々を1枚のリフト券で約600km滑ることができる。",
      'zh-hk': "全球其中一個最大型的跨國滑雪場：一張滑雪證覆蓋十多個法國及瑞士村莊，約600km雪道。",
    ...
    description: {
      ...
      ja: "Portes du Soleilはフランスとスイスの国境をまたいで十数のスキー場をつなぎ、約196基のリフトが支える約600kmのゲレンデを形成する。すべてがスキーのまま行き来できる大きな周回ルートで結ばれている。中級者向けのコースが中心で、樹林帯を抜けるコースも多く、家族向けのLes Getsから断崖上に立つモダンなAvoriazまで表情は実に多彩だ。ここでは4つのフランス側のスキー場を紹介しており、それぞれが同じ巨大な周回エリアへの異なる入り口となっている。",
      'zh-hk': "Portes du Soleil橫跨法國與瑞士邊境，將十多個滑雪場串連成約600km雪道，由約196座纜車服務，全部以滑雪方式相連成一個大環圈。雪道以中級為主，林蔭夾道，種類豐富，由適合家庭的Les Gets到聳立崖上、走現代風格的Avoriaz都有。本站介紹當中四個法國村莊，各自是通往同一大型雪圈的不同入口。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Mont Blancのふもとに広がる、日当たりのよい景観豊かな400kmのゲレンデ。Megève、Saint-Gervais、Comblouxが共有する。",
      'zh-hk': "Mont Blanc山下400km陽光充沛、風景如畫的雪道，由Megève、Saint-Gervais及Combloux共享。",
    ...
    description: {
      ...
      ja: "Évasion Mont-BlancはMegève、Saint-Gervais、Comblouxとその周辺を結び、Mont Blanc山塊に向き合う、なだらかで美しい景観を持つ400kmのゲレンデを形成する。中級者にとっての楽園であり、森を抜け開けたバルコニー状の地形を滑る長いクルージングコースは、アルプス随一の景観を背景に持つ。Megèveの洗練された雰囲気か、Saint-Gervaisの温泉町らしい静けさか、どちらを選んでも全体を滑ることができる。",
      'zh-hk': "Évasion Mont-Blanc將Megève、Saint-Gervais、Combloux及鄰近村莊連成一體，形成400km大多平緩、風景絕美的雪道，正對Mont Blanc山群。這裡是中級滑雪者的天堂，悠長暢滑的雪道穿林而過、越過開闊的觀景台地，背景是阿爾卑斯山最壯麗的景致。無論選擇時尚的Megève，還是溫泉小鎮般寧靜的Saint-Gervais，都能暢滑全場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Giffre谷を見下ろす265kmのゲレンデ。積雪の安定したFlaineから古い村Samoënsまで広がる。",
      'zh-hk': "Giffre山谷之上265km雪道，由積雪穩定的Flaine一直伸延至古樸村莊Samoëns。",
    ...
    description: {
      ...
      ja: "Grand MassifはFlaine、Samoëns、Morillon、Les Carroz、Sixtを結ぶ265kmのゲレンデで、積雪の安定したFlaineのボウル地形と、谷まで下る長いCascadesコースを頂点に持つ。標高の高い計画的に開発された拠点と、昔ながらのサヴォワ地方の村々が同居し、Genèveから1時間足らずの距離にある。ここではその2つの顔を紹介しており、同じスキー場への大きく異なる2つの拠点となっている。",
      'zh-hk': "Grand Massif將Flaine、Samoëns、Morillon、Les Carroz及Sixt連成265km雪道，以積雪穩定的Flaine雪盆及一路滑落山谷的長雪道Cascades為亮點。這裡糅合了高海拔、規劃完善的滑雪據點，與真正古老的Savoie村莊，車程不到一小時即達Geneva。本站介紹當中兩個入口，是通往同一滑雪場的兩種截然不同體驗。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "尾根越しにVarsとRisoulがつながる、南アルプスの日当たりのよいカラマツ林を抜ける185kmのゲレンデ。",
      'zh-hk': "Vars與Risoul越過山脊相連，185km陽光充沛的南阿爾卑斯雪道穿梭於落葉松林間。",
    ...
    description: {
      ...
      ja: "La Forêt BlancheはPic de Chabrièresを越えてVarsとRisoulを結び、南アルプスに広がる日当たりのよいカラマツ林の185kmのゲレンデを形成する。親しみやすくコストパフォーマンスに優れ、日照にも恵まれ、上級者を満足させる雄大な上級コースとオフピステも十分にそろう。どちらのスキー場を拠点にしても、尾根の向こうにエリア全体が開ける。",
      'zh-hk': "La Forêt Blanche越過Pic de Chabrières將Vars與Risoul連接起來，形成185km陽光充沛、兩旁盡是落葉松的南阿爾卑斯雪道。這裡氣氛友善、性價比高，天氣穩定晴朗，亦有足夠寬闊的紅色雪道及野雪滿足滑雪高手。無論落腳哪一個滑雪場，翻過山頭即是整片雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Galibierのふもとで結ばれたValloireとValmeinier。Maurienne地方の日当たりのよい150kmのゲレンデ。",
      'zh-hk': "Valloire與Valmeinier在Galibier山腳相連，150km陽光充沛的Maurienne雪道。",
    ...
    description: {
      ...
      ja: "Galibier-Thaborエリアは、古い村Valloireと、より静かなValmeinierを結び、伝説的なCol du Galibierのふもとに広がる150kmの日当たりのよい多彩なゲレンデを形成する。本物のサヴォワ地方らしさと、標高の高さゆえの安定した積雪を兼ね備え、価格はTarentaiseの大手スキー場よりずっと手頃だ。対照的な2つの拠点が、ひとつのつながったスキー場を形づくる。",
      'zh-hk': "Galibier-Thabor滑雪場將古樸村莊Valloire與較寧靜的Valmeinier連接起來，在傳奇的Col du Galibier山口下形成150km陽光充沛、變化多端的雪道。這裡糅合了地道的Savoie風情與可靠的高海拔積雪，價格遠低於Tarentaise一帶的大型滑雪場。兩個風格迥異的據點，同屬一個相連滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Col de la Madeleineを越えて結ばれたValmorelとSaint-François-Longchamp。1枚のリフト券で165kmを楽しめる。",
      'zh-hk': "Valmorel與Saint-François-Longchamp越過Col de la Madeleine山口相連，一張滑雪證暢滑165km。",
    ...
    description: {
      ...
      ja: "Le Grand DomaineはCol de la Madeleineを越えてValmorelとSaint-François-Longchampを結び、日当たりのよい、主に中級者向けの165kmのゲレンデを形成する。Savoie地方の中でもコストパフォーマンスに優れた家族向けスキー場のひとつで、控えめな雰囲気ながらよく整備され、混雑もめったにない。どちらのスキー場を選んでも、玄関先からエリア全体にアクセスできる。",
      'zh-hk': "Le Grand Domaine越過Col de la Madeleine山口將Valmorel與Saint-François-Longchamp連接起來，形成165km陽光充沛、以中級為主的雪道。這裡是Savoie地區性價比較高的家庭滑雪場之一，低調、規劃完善，甚少擠迫。無論落腳哪個滑雪場，出門就是整片雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "標高3330mのPic Blancから広がる、Oisans地方の日差したっぷりの250kmのゲレンデ。Alpe d'HuezとVaujanyが共有する。",
      'zh-hk': "從海拔3330m的Pic Blanc延伸出250km陽光普照的Oisans雪道，由Alpe d'Huez與Vaujany共享。",
    ...
    description: {
      ...
      ja: "Alpe d'Huez Grand DomaineはGrandes Rousses山塊に日照の良さで知られる250kmのゲレンデを広げ、標高3330mのPic Blancから滑り出す氷河コースから、アルプス最長の上級コースである全長16kmのSarenneまでを含む。活気あるAlpe d'Huezと静かな村Vaujanyは、まったく異なる2つの入り口だ。1枚のリフト券で山塊全体にアクセスできる。",
      'zh-hk': "Alpe d'Huez Grand Domaine在Grandes Rousses山群展開250km以陽光普照聞名的雪道，由海拔3330m的Pic Blanc冰川雪道，一直延伸至全長16km、阿爾卑斯山最長的黑色雪道Sarenne。熱鬧的Alpe d'Huez與寧靜村莊Vaujany，是截然不同的兩個入口。一張滑雪證，暢遊整個山群。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "国境を越える「天の川」。フランスのMontgenèvreとイタリアのSestriere、オリンピックのゲレンデを約400kmで結ぶ。",
      'zh-hk': "跨境「銀河」滑雪場：約400km雪道連接法國Montgenèvre與意大利Sestriere及奧運雪道。",
    ...
    description: {
      ...
      ja: "Via Lattea（天の川）は、フランスのMontgenèvreと、2006年オリンピック開催地であるイタリアのSestriere、Sauze d'Oulxほかの村々を結び、国境をまたぐ日当たりのよい標高の高い約400kmのゲレンデを形成する。広大で変化に富み、イタリア側はコストパフォーマンスにも優れ、長い滑走コースと雄大な眺めが楽しめる。1枚のリフト券でフランスとイタリアを行き来できる。",
      'zh-hk': "Via Lattea（意大利語「銀河」之意）將法國的Montgenèvre，與意大利的Sestriere、Sauze d'Oulx及其他2006年冬奧場地村莊連接起來，形成約400km橫跨邊境、陽光充沛的高海拔雪道。這裡幅員遼闊、種類豐富，意大利一側性價比極高，長雪道加上壯闊景觀。一張滑雪證即可往返法國與意大利。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Tosa d'Alpを越えて結ばれたLa MolinaとMasella。140kmはスペイン東ピレネー最大のスキー場となる。",
      'zh-hk': "La Molina與Masella越過Tosa d'Alp相連，140km雪道，是西班牙東庇里牛斯山最大的滑雪場。",
    ...
    description: {
      ...
      ja: "Alp 2500は歴史あるLa Molinaと森に囲まれたMasellaを、標高2537mのTosa d'Alpを越えて結び、140kmの日当たりのよい家族向けゲレンデを形成する、カタルーニャ・ピレネー最大の連結スキー場だ。Barcelonaから列車でも気軽にアクセスでき、樹林帯を抜ける長いコースとナイタースキーで知られる。2つのスキー場からなる、スペインでも屈指の親しみやすい大型スキー場だ。",
      'zh-hk': "Alp 2500越過海拔2537m的Tosa d'Alp，將歷史悠久的La Molina與林木環繞的Masella連接起來，形成140km陽光充沛、適合家庭的雪道，是加泰羅尼亞庇里牛斯山最大的相連滑雪場。從Barcelona出發，即使搭火車也能輕鬆到達，並以長樹林雪道及夜間滑雪聞名。兩個滑雪場合而為一，是西班牙數一數二親切友善的大型滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Tena谷にある2つのスキー場を1枚のAramónパスでカバー。活気あるFormigalと景観美しいPanticosa、合わせて216km。",
      'zh-hk': "Tena山谷兩個滑雪場共用一張Aramón滑雪證：熱鬧的Formigal與風景如畫的Panticosa，合共216km。",
    ...
    description: {
      ...
      ja: "FormigalとPanticosaはアラゴン州のTena谷にあり、1枚のAramónリフト券を共有して合計約216kmのゲレンデを形成する、スペイン・ピレネー最大のスキー圏だ。規模が大きく日当たりがよくパーティー好きなFormigalと、こぢんまりとして美しいPanticosa、そしてその谷を下ったところにある有名な温泉が好対照をなす。1枚のリフト券で両方の山にアクセスできる。",
      'zh-hk': "Formigal與Panticosa坐落於阿拉貢地區的Tena山谷，共用一張Aramón纜車證，合共約216km雪道，是西班牙庇里牛斯山最大的滑雪選擇。規模龐大、陽光充沛、熱愛派對的Formigal，與較小巧秀麗、山下設有著名溫泉的Panticosa形成強烈對比。一張滑雪證覆蓋兩座山。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "アンドラ西部のスキー場群。家族向けのPal-Arinsalとフリーライド向けのOrdino-Arcalísを、Vallnordの名でまとめる。",
      'zh-hk': "安道爾西部滑雪場：適合家庭的Pal-Arinsal與主打自由滑雪的Ordino-Arcalís，統稱Vallnord。",
    ...
    description: {
      ...
      ja: "Vallnordはアンドラ西部のスキー場、家族向けの連結エリアPal-Arinsalと、より荒々しく北向き斜面のOrdino-Arcalísをまとめ、合わせて約93kmの多彩なゲレンデを形成する。両者はあわせて、国の反対側にある巨大なGrandvaliraに対する、より積雪が豊富で静かな選択肢となる。性格の異なる2つの山を、Vallnordというひとつのアンドラの名がまとめている。",
      'zh-hk': "Vallnord將安道爾西部滑雪場合而為一，包括相連的家庭雪道Pal-Arinsal，以及較狂野、朝北的Ordino-Arcalís，合共約93km多樣化雪道。兩者加起來，成為國家另一端巨型滑雪場Grandvalira以外，積雪更多、更寧靜的另一選擇。兩座截然不同的山，共用Vallnord這個安道爾名字。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "オーストリア最大の連結スキー場。St. AntonとLech-Zürsが結ばれ305km、アルペンスキー発祥の地でもある。",
      'zh-hk': "奧地利最大相連滑雪場：St. Anton與Lech-Zürs合共305km，是高山滑雪的發源地。",
    ...
    description: {
      ...
      ja: "Ski ArlbergはSt. Anton、Lech、Zürs、Stuben、Warth-Schröckenを結び、305kmのゲレンデと約88基のリフトを持つ、オーストリア最大の連結スキー場であり、近代アルペン技術発祥の地でもある。St. Antonの伝説的なオフピステと夜の賑わいと、Lech-Zürsの洗練された積雪の安定したボウル地形が、1枚のリフト券と有名な周回コースWhite Ringで結ばれる。ここではその中核をなす2つの主要スキー場を紹介する。",
      'zh-hk': "Ski Arlberg將St. Anton、Lech、Zürs、Stuben及Warth-Schröcken連成305km雪道及約88座纜車，是奧地利最大的相連滑雪場，亦是現代高山滑雪技術的發源地。這裡集St. Anton傳奇的野雪與夜生活，與Lech-Zürs時尚、積雪穩定的雪盆於一身，全部由一張滑雪證覆蓋，還有著名的White Ring環圈雪道。本站介紹當中兩個重點滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "伝説のMont Blanc谷。ChamonixとLes Houches、Mont Blanc Unlimitedパスでカバーする170kmのゲレンデ。",
      'zh-hk': "傳奇的Mont Blanc山谷：Chamonix與Les Houches，Mont Blanc Unlimited滑雪證覆蓋170km雪道。",
    ...
    description: {
      ...
      ja: "Chamonix谷はMont Blancのふもとに点在する複数のエリアにまたがる170kmのゲレンデを持ち、Les Houchesのなだらかな樹林帯の斜面から、氷河に縁取られたGrands Montetsの急峻な地形まで幅広い。Mont Blanc Unlimitedパスがこれらをひとつにまとめ、イタリアやスイスにまで及ぶ。スキー場である以上に登山の聖地であり、景観と本格的なオフピステにおいて他の追随を許さない。",
      'zh-hk': "Chamonix山谷在Mont Blanc山腳分成多個獨立區域，展開170km雪道，由Les Houches平緩的林間斜坡，到Grands Montets陡峭、冰川環繞的地形都有。Mont Blanc Unlimited滑雪證將各區連成一體，更可延伸至意大利及瑞士。這裡既是滑雪勝地，更是登山之都，景致與正宗野雪體驗均無出其右。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Annecy近郊、隣り合うAravis山塊の2つのスキー場La ClusazとLe Grand-Bornand。合わせて約220km。",
      'zh-hk': "Annecy附近兩個相鄰的Aravis滑雪場，La Clusaz與Le Grand-Bornand，合共約220km雪道。",
    ...
    description: {
      ...
      ja: "Annecyの上にそびえるAravis山塊には、北アルプスの中でも特に本物らしさを保つ2つのスキー場、La ClusazとLe Grand-Bornandがあり、合わせて約220kmの日当たりのよいゲレンデと共通のローカルリフト券を持つ。どちらも今も生活が息づくサヴォワ地方の村で、高層ホテルの利便性よりも、個性、食、樹林帯を抜けるコースの魅力で勝負する。Genèveに近く、週末の人気の行き先だ。",
      'zh-hk': "Annecy上方的Aravis山群坐擁北阿爾卑斯山區兩個最地道的滑雪場，La Clusaz與Le Grand-Bornand，合共約220km陽光充沛的雪道，並共用一張本地滑雪證。兩者都是仍有居民生活的正宗Savoie村莊，勝在個性、美食及林蔭雪道，而非高樓式的便利。鄰近Geneva，是深受歡迎的週末度假之選。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Eiger、Mönch、Jungfrauがそびえる由緒あるエリア。Grindelwald、Wengen、Mürrenを結び、1枚のリフト券で約206km。",
      'zh-hk': "Eiger、Mönch及Jungfrau三峰俯瞰這片充滿故事的滑雪區域，連接Grindelwald、Wengen及Mürren，一張滑雪證暢滑約206km。",
    ...
    description: {
      ...
      ja: "Jungfrau Ski RegionはGrindelwald、Wengen、断崖の上に立つMürren-Schilthornエリアを1枚のリフト券にまとめ、伝説的なEiger北壁のふもとに約206kmのゲレンデを持つ。大部分はなだらかな中級コースで、比類ない景観に恵まれ、勇気ある者にはLauberhornやInfernoのレースコースも用意されている。登山鉄道とロープウェイがすべてをつなぎ、車をほとんど使わないスイスらしい伝統的なスキーの、最も美しい形がここにある。",
      'zh-hk': "Jungfrau Ski Region將Grindelwald、Wengen及聳立崖上的Mürren-Schilthorn區域，統歸一張滑雪證，在傳奇的Eiger北壁下形成約206km雪道。雪道大多平緩，屬中級暢滑路線，景致無可匹敵，亦設有Lauberhorn及Inferno賽道供勇者挑戰。齒軌鐵路與纜車將一切連接起來，堪稱經典、少用汽車的瑞士滑雪體驗，美得無以復加。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "スイス最大の連結スキー場。Mont-Fortのふもとで、Verbier、Nendaz、Veysonnaz、Thyonを410kmで結ぶ。",
      'zh-hk': "瑞士最大相連滑雪場：410km雪道在Mont-Fort山下連接Verbier、Nendaz、Veysonnaz及Thyon。",
    ...
    description: {
      ...
      ja: "4 Vallées はスイス最大の連結スキー場で、華やかなVerbierとNendaz、Veysonnaz、Thyonを、Valais地方の4つの日当たりのよい谷にわたって410kmで結ぶ。標高3330mのMont-Fort氷河まで登り、広大な中級コースと、Tortinのコブ斜面のような急峻で伝説的なオフピステが同居する。洗練されたVerbierか、よりコストパフォーマンスに優れたNendazを拠点にすれば、1枚のリフト券で全域を滑ることができる。",
      'zh-hk': "4 Vallées是瑞士最大的相連滑雪場，410km雪道橫跨Valais地區四個陽光充沛的山谷，將時尚的Verbier與Nendaz、Veysonnaz及Thyon連接起來。雪道一路攀升至海拔3330m的Mont-Fort冰川，糅合大量中級暢滑雪道與陡峭傳奇的野雪地形，例如Tortin的雪包地形。無論落腳時尚的Verbier，還是性價比較高的Nendaz，一張滑雪證即可暢滑全場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "丘を越えて結ばれたVillars-GryonとLes Diablerets。積雪の安定したGlacier 3000を頂点とする125kmのゲレンデ。",
      'zh-hk': "Villars-Gryon與Les Diablerets越過山頭相連，125km雪道以積雪穩定的Glacier 3000為最高點。",
    ...
    description: {
      ...
      ja: "Villars-GryonとLes Diableretsは山を越えて結ばれ、標高2971mの積雪の安定したGlacier 3000を頂点とする、Vaud地方アルプスの日当たりのよい125kmのスキー場を形成する。地形の大部分はなだらかで景観に恵まれ、家族連れに最適で、Dents du MidiやMont Blancへの雄大な眺めも楽しめる。2つの伝統的な村が、GenèveやLausanneから気軽に行ける、ひとつのくつろいだスキー場をつくっている。",
      'zh-hk': "Villars-Gryon與Les Diablerets越過山頭連成一體，在Vaud阿爾卑斯山區形成125km陽光充沛的滑雪場，以海拔2971m、積雪穩定的Glacier 3000為最高點。地形大多平緩、風景優美，非常適合家庭，更可遠眺Dents du Midi及Mont Blanc的壯麗景致。兩個傳統村莊，一個悠閒滑雪場，由Geneva及Lausanne出發車程輕鬆可達。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "オーストリア最大のリフト券。SchladmingからGastein谷、Flachauまで、5つの地域にまたがる760km。",
      'zh-hk': "奧地利最大滑雪證：760km雪道橫跨五個地區，由Schladming一直伸延至Gastein山谷及Flachau。",
    ...
    description: {
      ...
      ja: "Ski amadéはオーストリア最大のスキーパスで、1枚のチケットでSchladmingの4-Berge Skischaukel、FlachauのSnow Space Salzburg、Gastein谷を含む5つの地域、約760kmのゲレンデと270基のリフトをカバーする。地形は圧倒的に広く、よく整備された中級コースが中心で、ナイタースキー、ワールドカップ開催コース、Gasteinの有名な温泉も揃う。1枚のリフト券で、SalzburgとStyria地方の広大なスキーエリアを楽しめる。",
      'zh-hk': "Ski amadé是奧地利最大的滑雪證，一張門票覆蓋五個地區約760km雪道及270座纜車，包括Schladming的4-Berge Skischaukel、Flachau的Snow Space Salzburg及Gastein山谷。地形絕大部分寬闊平緩、修整完善，屬中級雪道，並設有夜間滑雪、世界盃賽道，以及Gastein著名的溫泉。一張滑雪證，暢遊Salzburg及Styria地區廣闊的滑雪天地。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "湖畔のZell am Seeと、KaprunのKitzsteinhorn氷河を1枚のAlpin Cardで。標高の高い場所では積雪が保証された138km。",
      'zh-hk': "湖畔小鎮Zell am See與Kaprun的Kitzsteinhorn冰川共用一張Alpin Card，138km雪道，高海拔地帶積雪有保證。",
    ...
    description: {
      ...
      ja: "Alpin CardはZell am SeeのSchmittenhöheでの湖と山を望むスキーと、KaprunのKitzsteinhorn氷河を結び、合計約138kmを形成する。ターコイズブルーの湖を見下ろす景観豊かな中級コースと、谷の積雪が心もとないときのための標高3029mまでの積雪が安定した氷河スキーという、賢い組み合わせだ。1枚のチケットで両方をカバーし、Salzburgアルプスの中でも屈指の絶景ポイントとなっている。",
      'zh-hk': "Alpin Card將Zell am See的Schmittenhöhe湖光山色滑雪體驗，與Kaprun的Kitzsteinhorn冰川連接起來，合共約138km。這是聰明的組合：碧藍湖泊之上是風景如畫的中級雪道，加上山谷積雪不足時，可轉往海拔3029m積雪穩定的冰川滑雪。一張門票覆蓋兩地，位處Salzburg阿爾卑斯山區最上鏡的一角。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "SaalbachとFieberbrunnが軸となる巨大なSkicircus。リフトで結ばれた270kmのゲレンデに、伝説的なアプレスキーとフリーライドが加わる。",
      'zh-hk': "Saalbach與Fieberbrunn是巨型滑雪場Skicircus的兩大支柱，270km雪道由纜車串連，兼具傳奇的滑雪後派對及自由滑雪。",
    ...
    description: {
      ...
      ja: "Skicircus Saalbach Hinterglemm Leogang Fieberbrunnはオーストリア最大級の連結スキー場のひとつで、日当たりのよい谷をぐるりと囲み、Fieberbrunnのフリーライド斜面まで及ぶ270kmのゲレンデを持つ。壮大な周回コース、幅広い中級クルージングコース、そして午後の早い時間から始まるアプレスキーの盛り上がりで知られる。華やかなSaalbachと、より積雪に恵まれたFieberbrunnは、同じ広大な周回エリアへのまったく異なる2つの入り口だ。",
      'zh-hk': "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn是奧地利其中一個最大的相連滑雪場，270km雪道環繞一個陽光充沛的山谷，並延伸至Fieberbrunn的自由滑雪地帶。這裡以壯觀的環形雪道、寬闊的中級暢滑雪道，以及由下午時分開始的滑雪後派對氣氛而聞名。時尚的Saalbach與積雪更豐富的Fieberbrunn，是通往同一巨型雪圈的兩種截然不同體驗。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "ひとつの谷に4つのスキー場とHintertux氷河。Zillertal Superskipassは、Tyrol地方で500kmを超える。",
      'zh-hk': "一個山谷、四個滑雪場，加上Hintertux冰川：Zillertal Superskipass在Tyrol地區覆蓋超過500km雪道。",
    ...
    description: {
      ...
      ja: "Zillertalはひとつのチロル地方の谷に4つの独立したスキー場を凝縮し、すべてZillertal Superskipassでカバーされ、合わせて500kmを大きく超えるゲレンデとなる。Mayrhofenは急峻なHarakiriと大型スキー場ならではの活気を、Gerlos周辺のZillertal Arenaは日当たりのよいクルージングコースを、そして標高3250mのHintertux氷河は年365日の積雪を保証する。なだらかな初心者用ゲレンデから通年の氷河スキーまでそろう、アルプスでも屈指の完成度を誇るスキー渓谷だ。",
      'zh-hk': "Zillertal將四個獨立滑雪場濃縮於一個Tyrol山谷之中，全部涵蓋在Zillertal Superskipass之內，合共超過500km雪道。Mayrhofen帶來陡峭的Harakiri雪道及大型滑雪場的熱鬧氣氛，Gerlos一帶的Zillertal Arena增添陽光充沛的暢滑雪道，而Hintertux冰川則在海拔3250m處保證全年365日都有積雪。這裡是阿爾卑斯山區最完整的滑雪山谷之一，由平緩的初學者雪道到全年不斷的冰川滑雪都齊備。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "世界最大のスキーパス。UNESCO世界遺産の峰々のふもと、12のDolomiti渓谷にまたがる約1200kmを1枚のチケットでカバーする。",
      'zh-hk': "全球最大的滑雪證：一張門票覆蓋12個Dolomiti山谷，約1200km雪道，盡在聯合國教科文組織世界遺產山峰之下。",
    ...
    description: {
      ...
      ja: "Dolomiti SuperskiはDolomiti山塊にある十数のスキー場を結び、UNESCO世界遺産に登録された伝説的な白い岩壁のふもとに広がる、主に中級者向けの約1200kmのゲレンデを1枚のチケットでカバーする。Sella Rondaの谷々（Val Gardena、Alta Badia、Val di Fassa、Arabba）、Cortina d'Ampezzo、山頂が平らなKronplatz、San Martino di Castrozzaほかをつなぐ。地球上最大の単一リフト券であり、チェアリフトに乗るたびに絵葉書のような景色が広がる。",
      'zh-hk': "Dolomiti Superski將Dolomiti山區十多個獨立滑雪場連成一體，形成約1200km大多屬中級程度的雪道，一張門票即可通行，盡在聯合國教科文組織世界遺產、傳奇的淡色岩壁之下。滑雪場連接Sella Ronda各山谷（Val Gardena、Alta Badia、Val di Fassa、Arabba）、Cortina d'Ampezzo、山頂平坦的Kronplatz、San Martino di Castrozza及更多地方。這是全球最大的單一滑雪證，每程吊椅纜車都如明信片般美不勝收。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Monte Rosaのふもとで結ばれた3つのWalser渓谷。標高が高く景観豊かな180kmのゲレンデに、アルプス屈指のフリーライドが加わる。",
      'zh-hk': "三個Walser山谷在Monte Rosa山下相連，180km高海拔、風景優美的雪道，加上阿爾卑斯山區數一數二的自由滑雪體驗。",
    ...
    description: {
      ...
      ja: "Monterosa Skiは、アルプス第2位の高峰Monte Rosaの南壁のふもとで3つのWalser渓谷を結び、Alagna、Champoluc、Gressoneyが共有する、標高が高く景観豊かな180kmのゲレンデを形成する。ゲレンデスキーの大部分は幅広く中級者向けだが、本当の魅力はオフピステにある。Alagnaの長く定番のラインとヘリスキーへの手軽なアクセスは、あらゆるフリーライダーの憧れのリストに載る。性格の大きく異なる3つの村が、イタリアでも屈指の野性味あふれる大型スキー場をつくっている。",
      'zh-hk': "Monterosa Ski在阿爾卑斯山第二高峰Monte Rosa南壁下，將三個Walser山谷連成一體，形成180km高海拔、風景優美的雪道，由Alagna、Champoluc及Gressoney共享。雪道滑雪大多寬闊、屬中級程度，但真正吸引之處在於野雪：Alagna經典的長雪道，加上輕鬆可達的直升機滑雪，令這裡成為每位自由滑雪愛好者的心願清單之選。三個風格迥異的村莊，組成意大利數一數二狂野的大型滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Little St Bernard峠を越えて結ばれた、フランスのLa Rosièreとイタリアのla Thuile。国境をまたぐ1枚のリフト券で152km。",
      'zh-hk': "法國的La Rosière與意大利的La Thuile越過Little St Bernard山口相連，一張跨境滑雪證暢滑152km。",
    ...
    description: {
      ...
      ja: "Espace San Bernardoは、フランスTarentaise地方の日当たりのよいLa Rosièreと、イタリアAosta谷の静かなLa Thuileを、Little St Bernard峠を越えて結び、152kmの共有ゲレンデを形成する。標高と斜面の向きのおかげで安定した積雪に恵まれ、1枚のチケットでスキーのまま2か国をまたげることで有名だ。ランチもフランス側のタルティフレットからイタリア側のボンバルディーノへと変わる、アルプスの中でも特に本物の国境越え体験ができるスキー場だ。",
      'zh-hk': "Espace San Bernardo越過Little St Bernard山口，將法國Tarentaise地區陽光充沛的La Rosière，與意大利Aosta山谷較寧靜的La Thuile連接起來，形成152km共享雪道。憑藉海拔與坡向優勢，積雪一向穩定可靠，並以一張門票即可滑雪跨越兩國而聞名。午餐也從法國一側的tartiflette，變成意大利一側的bombardino，是阿爾卑斯山區最貨真價實的跨境滑雪體驗之一。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Madonna di Campiglioと、Val di Sole地方の村FolgaridaとMarilleva。Brenta Dolomitiを越えて結ばれ、1枚のリフト券で150km。",
      'zh-hk': "Madonna di Campiglio與Val di Sole地區的Folgarida及Marilleva村莊，越過Brenta Dolomiti山群相連，一張滑雪證暢滑150km。",
    ...
    description: {
      ...
      ja: "Madonna-Folgarida-Marillevaエリアは、洗練されたMadonna di Campiglioと、より日当たりがよくコストパフォーマンスに優れたVal di Sole地方の村FolgaridaとMarillevaを、Brenta Dolomitiの尾根を越えて結び、幅が広くよく整備された150kmのゲレンデを形成する。夜はおしゃれなMadonna、昼は家族向けのFolgaridaとMarillevaという、イタリアを代表する性格の異なるスキー場の組み合わせだ。3つのスキー場はいずれも、より広いSkirama Dolomitiパスに含まれ、さらに熱心なスキーヤー向けに周辺の谷も追加できる。",
      'zh-hk': "Madonna-Folgarida-Marilleva滑雪場越過Brenta Dolomiti山脊，將時尚的Madonna di Campiglio，與較多陽光、性價比更高的Val di Sole地區村莊Folgarida及Marilleva連接起來，形成150km寬闊、修整完善的雪道。這裡是意大利其中一個風格多元的滑雪場代表：晚上盡顯Madonna的華麗，白天則有適合家庭的Folgarida與Marilleva。三地均涵蓋在更廣闊的Skirama Dolomiti滑雪證之內，為最熱衷的滑雪客加入鄰近山谷選擇。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "南アルプスの尾根を越えて結ばれたPra-LoupとLa Foux d'Allos。日当たりのよい1枚のリフト券で180km。",
      'zh-hk': "Pra-Loup與La Foux d'Allos越過南阿爾卑斯山脊相連，一張陽光充沛的滑雪證暢滑180km。",
    ...
    description: {
      ...
      ja: "Espace LumièreはUbaye地方のPra-Loupと、Val d'Allos地方のLa Foux d'Allosを、南アルプスの尾根を越えて結び、標高1500mから2600mの間に広がる、日当たりのよい主に中級者向けの180kmのゲレンデを形成する。斜面の向きと標高のおかげで積雪は安定し、光は南仏らしい輝きを放つ。麓にはカラマツ林、上部には開けたボウル地形が広がる。1枚のリフト券、2つの谷、そしてフランスの大型スキー場の中でも特に過小評価されているエリアのひとつだ。",
      'zh-hk': "Espace Lumière越過南阿爾卑斯山脊，將Ubaye地區的Pra-Loup與Val d'Allos地區的La Foux d'Allos連接起來，形成海拔1500m至2600m之間、陽光充沛、以中級為主的180km雪道。坡向與海拔令積雪穩定可靠，陽光更是南法獨有的燦爛，山下是落葉松林，山上則是開闊的雪盆地形。一張滑雪證、兩個山谷，是法國其中一個最被低估的大型滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Les Saisies、Crest-Voland、Notre-Dame-de-Bellecombe、Praz-sur-Arlyが結ばれた192km。Val d'Arly地方、Mont Blancを望む日当たりのよいゲレンデ。",
      'zh-hk': "Les Saisies、Crest-Voland、Notre-Dame-de-Bellecombe及Praz-sur-Arly連成192km雪道，陽光充沛的Val d'Arly雪道更可遠眺Mont Blanc。",
    ...
    description: {
      ...
      ja: "Espace DiamantはVal d'Arly地方とBeaufortain地方の5つの村を結び、Mont Blancへの雄大な眺めを持つ、主に中級者向けの美しく日当たりのよい192kmのゲレンデを形成する。標高が高く積雪の安定したLes Saisiesがエリアの中核をなし、Crest-VolandやNotre-Dame-de-Bellecombeのようなより静かな村々が、本物のサヴォワ地方らしい雰囲気と手頃な価格を保っている。大型スキー場特有の喧騒を避けつつ広い滑走距離を求める家族連れや中級者に人気だ。",
      'zh-hk': "Espace Diamant將Val d'Arly及Beaufortain地區五個村莊連成一體，形成192km大多屬中級程度、陽光燦爛的雪道，可遠眺Mont Blanc壯麗景致。地勢較高、積雪穩定的Les Saisies是整個滑雪場的支柱，而Crest-Voland及Notre-Dame-de-Bellecombe等較寧靜的村莊，則保留地道的Savoie風情及更親民的價格。深受追求豐富雪道里數、卻不想置身大型滑雪場喧鬧氣氛的家庭與中級滑雪者歡迎。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "1枚のAlta Valtellinaパスで、BormioとSanta Caterina Valfurvaへ。Stelvio国立公園内の115km。",
      'zh-hk': "Bormio與Santa Caterina Valfurva共用一張Alta Valtellina滑雪證，115km雪道位於Stelvio國家公園內。",
    ...
    description: {
      ...
      ja: "Alta Valtellinaパスは、歴史あるBormioと、Stelvio国立公園の縁にある積雪の安定したSanta Caterina Valfurvaを結び、本格的なワールドカップの実績を持つ、主に上級・最上級コースからなる約115kmのゲレンデを形成する。Bormioは容赦なく急なStelvio滑降コースと、標高3012mからの1800mの標高差を、Santa Caterinaはより高い標高にオリンピック級のレースコースを提供する。Bormioのローマ時代からの温泉も加われば、イタリアで最も壮観なアルプスの一角にある、上級スキーヤー向けの拠点となる。",
      'zh-hk': "Alta Valtellina滑雪證將歷史悠久的Bormio，與位於Stelvio國家公園邊緣、積雪穩定的Santa Caterina Valfurva連接起來，形成約115km大多屬紅色及黑色程度的雪道，擁有深厚的世界盃賽事底蘊。Bormio帶來極其陡峭的Stelvio速降賽道，由海拔3012m一路下降1800m落差；Santa Caterina則在更高海拔提供奧運級賽道地形。加上Bormio的羅馬溫泉作為額外驚喜，這裡是意大利其中一個最壯觀的阿爾卑斯山角落，屬於滑雪高手的據點。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Passo TonaleとPonte di Legnoを結ぶ、標高の高い100kmのゲレンデ。標高3016mのPresena氷河が5月まで積雪を保証する。",
      'zh-hk': "Passo Tonale與Ponte di Legno連成100km高海拔雪道，海拔3016m的Presena冰川保證積雪直至五月。",
    ...
    description: {
      ...
      ja: "Adamello Skiは、標高の高いPasso Tonaleと、歴史ある町Ponte di Legnoをひとつの山越えのリンクで結び、標高3016mの積雪の安定したPresena氷河を頂点とする、主に中級者向けの100kmのゲレンデを形成する。その対比は鮮やかだ。標高1883mに計画的に開発されたスキーイン・スキーアウトのスキー場と、標高1257mに今も人々が暮らす、柱廊とクリスマスマーケットで知られるロンバルディアの町。1枚のリフト券が両方をカバーし、5月まで滑走できる。",
      'zh-hk': "Adamello Ski透過單一山區連接，將地勢較高的Passo Tonale山口與歷史悠久的Ponte di Legno小鎮連結起來，形成100km大多屬中級程度的雪道，以海拔3016m、積雪穩定的Presena冰川為最高點。兩地對比鮮明：一邊是海拔1883m規劃完善的ski-in/ski-out滑雪場，另一邊是海拔1257m、仍有居民生活的正宗Lombardia小鎮，設有騎樓建築及著名聖誕市集。一張滑雪證覆蓋兩地，雪季可延續至五月。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "1枚のリフト券で結ばれたDavosとKlosters。Graubünden地方のParsenn、Madrisa、Gotschna、Jakobshornにまたがる300km。",
      'zh-hk': "Davos與Klosters共用一張滑雪證，300km雪道橫跨Graubünden地區的Parsenn、Madrisa、Gotschna及Jakobshorn。",
    ...
    description: {
      ...
      ja: "Davos Klostersパスは、Landwasser谷上流に広がる6つのリフトが通う山々を結び、Parsennの開けた尾根から、急峻なJakobshorn、Klosters上の家族向けMadrisaまで、300kmのゲレンデを形成する。Davosは都会的な側（町中に登山鉄道が走るスイスらしい町）、Klostersは絵に描いたように可愛らしい側だ。どちらを拠点にしても、同じチケットでエリア全体にアクセスできる。",
      'zh-hk': "Davos Klosters滑雪證將Landwasser山谷上游六座設有纜車的山峰串連起來，形成300km雪道，由Parsenn開闊的山脊，到陡峭的Jakobshorn，以及Klosters上方適合家庭的Madrisa都涵蓋在內。Davos是較都市化的一面（設有齒軌鐵路貫穿市中心的瑞士小鎮），Klosters則如童話小鎮般精緻。無論落腳哪一邊，同一張門票都能暢遊全場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "オーストリア最大の連結スキー場。Wilder Kaiserのふもとで9つのチロル地方の村を結ぶ、主に中級者向けの284kmのゲレンデ。",
      'zh-hk': "奧地利最大的相連滑雪場：284km大多屬中級程度的雪道，在Wilder Kaiser山下連接九個Tyrol村莊。",
    ...
    description: {
      ...
      ja: "SkiWeltはSöll、Westendorf、Going、Ellmau、Scheffau、Brixenと、3つの小さな周辺の村を結び、Wilder Kaiserの劇的な石灰岩の岩壁のふもとに284kmのゲレンデを形成する。スキーの大部分は幅広い中級クルージングコースで、レベルの異なるグループにも最適。Hochsöllでのナイタースキーやヨーロッパ屈指の規模を誇る人工降雪システムも備える。どちらの拠点も、玉ねぎ型の教会とGasthof（宿屋）文化が息づく、いかにもオーストリアらしい雰囲気を保っている。",
      'zh-hk': "SkiWelt將Söll、Westendorf、Going、Ellmau、Scheffau、Brixen及三個較小的周邊村莊連成一體，在Wilder Kaiser壯觀的石灰岩壁下形成284km雪道。滑雪體驗以寬闊的中級暢滑雪道為主，非常適合程度參差的團體，另設Hochsöll夜間滑雪，以及歐洲數一數二龐大的人工造雪系統。無論落腳哪個村莊，都散發著地道奧地利風情，洋蔥頂教堂與Gasthof旅館文化隨處可見。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "ドイツ最高峰Zugspitzeを取り巻く山々。チロル地方のLermoosとバイエルン地方のGarmisch-Partenkirchenを、国境をまたぐ1枚のリフト券で。",
      'zh-hk': "環繞德國最高峰Zugspitze的群山：Tyrol地區的Lermoos與Bavaria地區的Garmisch-Partenkirchen，共用一張跨境滑雪證。",
    ...
    description: {
      ...
      ja: "Tiroler Zugspitz Arenaは、Zugspitzeのオーストリア側にあるLermoos、Ehrwaldとより小さなチロル地方の村々をまとめ、Top Snow Cardはドイツ側のGarmisch-Partenkirchenと氷河Zugspitzplattまで対象を広げ、約150kmのゲレンデと、標高2962mというドイツでリフトが通う最高地点をカバーする。魅力は国境を越える体験そのものにある。同じ日に2つの国から同じ峰の下でスキーができる。",
      'zh-hk': "Tiroler Zugspitz Arena將Zugspitze奧地利一側的Lermoos、Ehrwald及較小的Tyrol村莊集結一起，Top Snow Card滑雪證更延伸至德國一側的Garmisch-Partenkirchen及Zugspitzplatt冰川，合共約150km雪道，海拔2962m更是德國纜車可達的最高點。最大賣點在於跨境體驗：同一天內於同一山峰下，橫跨兩國滑雪。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "IschglとスイスのSamnaunを結ぶ、標高の高い国境をまたぐ239kmのゲレンデ。帰りのロープウェイ乗り場では免税ショッピングも楽しめる。",
      'zh-hk': "Ischgl與瑞士的Samnaun連成239km高海拔跨境雪道，回程纜車山腳更設有免稅購物。",
    ...
    description: {
      ...
      ja: "Silvretta Arenaは、オーストリアのIschglとスイスのSamnaunを、Paznaun側の尾根を越えて結び、45基のリフトが支える、大部分が標高2000m以上にある239kmのゲレンデを形成する。標高と斜面の向きのおかげで5月上旬まで積雪が安定し、有名な2階建てロープウェイがSamnaunの免税店からAlp Tridaを経てオーストリアへとスキーヤーを運ぶ。1枚のリフト券で2か国をカバーする、ヨーロッパ屈指の高標高スキー場だ。",
      'zh-hk': "Silvretta Arena越過Paznaun一側的山脊，將奧地利的Ischgl與瑞士的Samnaun連接起來，形成239km大多位於海拔2000m以上的雪道，由45座纜車服務。憑藉海拔與坡向優勢，積雪穩定可延續至五月初，著名的雙層纜車更會載著滑雪客從Samnaun的免稅商店，經Alp Trida返回奧地利。一張滑雪證覆蓋兩國，是歐洲數一數二的高海拔大型滑雪場。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Oberalp峠を越えて結ばれたAndermatt、Sedrun、Disentis。1枚のチケットでスイス中部の180kmをカバーする。",
      'zh-hk': "Andermatt、Sedrun及Disentis越過Oberalp山口相連，一張門票暢滑瑞士中部180km雪道。",
    ...
    description: {
      ...
      ja: "エジプトの投資家Sawirisの資金によるGotthard地域の再開発により、Andermatt、Sedrun、Disentisが1枚のSkiArenaチケットにまとまった。180kmのゲレンデ、33基のリフト、そしてUri州とGraubünden州を結ぶOberalp峠の連結だ。Andermattは都会的で洗練された側、Sedrunは積雪の安定した中間地点、Disentisはロマンシュ語圏の静かな終点にあたる。Andermatt上のGemsstockとSedrun上のSchneehüenerstockでは、氷河の縁を滑るスキーも楽しめる。",
      'zh-hk': "埃及投資者Sawiris出資開發Gotthard地區，令Andermatt、Sedrun及Disentis統歸一張SkiArena門票：180km雪道、33座纜車，並由Oberalp山口連接Uri州與Graubünden州。Andermatt是都會時尚的一面，Sedrun是積雪穩定的中段，Disentis則是說羅曼什語、氣氛寧靜的終點。Andermatt上方的Gemsstock及Sedrun上方的Schneehüenerstock，均可體驗冰川邊緣滑雪。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Aletsch氷河を見下ろす、車の入れないバルコニー状の高台にあるBettmeralpとRiederalp。UNESCO世界遺産の絶景に広がる104kmのゲレンデ。",
      'zh-hk': "Bettmeralp與Riederalp坐落於Aletsch冰川上方無車的觀景台地，104km雪道盡覽聯合國教科文組織世界遺產全景。",
    ...
    description: {
      ...
      ja: "Aletsch Arenaは、アルプス最長の氷河を見下ろす南向きの高台にあるBettmeralp、Riederalp、Fiescheralpをまとめる。いずれも車が入れず、谷からロープウェイでのみアクセスできる村々だ。104kmのゲレンデ、35基のリフト、ドアの前までスキーで帰れるシャレーがいたるところにあり、UNESCO世界遺産のAletsch氷河が背景となる。標高と斜面の向きのおかげで積雪は安定し、ほとんどの年で5月まで滑走できる。",
      'zh-hk': "Aletsch Arena將Bettmeralp、Riederalp及Fiescheralp集結於阿爾卑斯山最長冰川上方、朝南的高地觀景台，全部都是無車村莊，只能從山谷搭纜車前往。104km雪道、35座纜車，隨處可見可直接滑雪返回的度假木屋，背景則是列入聯合國教科文組織世界遺產的Aletsch冰川。憑藉海拔與坡向優勢，積雪穩定，大部分年份都可滑雪至五月。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "山を越えて結ばれた2つのBregenzerwaldの村。オーストリアで最も雪深いエリアと評される110kmのゲレンデ。",
      'zh-hk': "兩個Bregenzerwald村莊越過山頭相連，110km雪道位於常被譽為奧地利積雪最豐富的角落。",
    ...
    description: {
      ...
      ja: "Damüls-Mellauは2つのBregenzerwaldの村を、Mittagspitzeエリアを越えて結び、合わせて29基のリフトを持つ110kmのゲレンデを形成する。年間積雪量はオーストリア最多としてしばしば引き合いに出され（上部斜面では年9mを大きく超えることも多い）、大部分は森林限界より上にあり、北向き斜面には本格的なフリーライド地形、幅広の正面斜面には手軽な中級クルージングコースが広がる。両方の村に美しいBregenzerwald様式のWälderhaus建築が残る。",
      'zh-hk': "Damüls-Mellau將兩個Bregenzerwald村莊連接起來，越過Mittagspitze區域形成110km雪道，合共29座纜車，積雪紀錄更常被譽為奧地利之最（上部斜坡年降雪量往往遠超9米）。雪道大多位於林木線以上，北面設有正宗的自由滑雪地形，寬闊的正面雪道則適合輕鬆的中級暢滑。兩個村莊均保留美麗的Bregenzerwald Wälderhaus傳統建築。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Mischabelのふもと、標高の高いValais谷を共有するSaas-FeeとSaas-Almagell。氷河による安定した積雪を誇る145kmのゲレンデを1枚のリフト券でカバーする。",
      'zh-hk': "Saas-Fee與Saas-Almagell共享Mischabel山下地勢較高的Valais山谷，一張滑雪證暢滑145km積雪穩定的冰川雪道。",
    ...
    description: {
      ...
      ja: "Saastal Cardは、Saas谷の最奥にあるSaas-Fee、Saas-Almagell、Saas-Grund、Saas-Balenをまとめ、標高3500mのSaas-Fee氷河（5月まで積雪が安定）まで達する145kmのゲレンデ、27基のリフト、Mischabel山群へのスキーツーリングのアクセスを提供する。Saas-Feeは車の入れない旗艦的な村、Almagell、Grund、Balenはより静かでお手頃な選択肢だ。1枚のリフト券で谷全体をカバーする。",
      'zh-hk': "Saastal Card將Saas谷源頭的Saas-Fee、Saas-Almagell、Saas-Grund及Saas-Balen集結一起，145km雪道最高可達海拔3500m的Saas-Fee冰川（積雪穩定至五月），設27座纜車，並可通往Mischabel山群作滑雪登山之旅。Saas-Fee是無車的旗艦滑雪場；Almagell、Grund及Balen則是較寧靜、價格親民的選擇。一張滑雪證覆蓋整個山谷。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Saalbach、Hinterglemm、Leogang、Fieberbrunnが結ばれた270kmのゲレンデ。オーストリア最大級のスキー周回コースのひとつ。",
      'zh-hk': "Saalbach、Hinterglemm、Leogang及Fieberbrunn連成270km雪道，是奧地利數一數二的大型滑雪環圈。",
    ...
    description: {
      ...
      ja: "SkicircusはSalzburger Land地方の4つの村を、壮大な周回コースで結び、270kmのゲレンデ、70基のリフト、そしてSalzburgとTirolの境にある日当たりのよさで知られる立地を持つ。Saalbachはアプレスキーの重鎮、Hinterglemmは谷の奥にある家族向けの拠点、Leogangはスノーパークとバイクパークが自慢の妹分、Fieberbrunnはフリーライドの拠点だ。1枚のリフト券で周回コース全体をカバーする。",
      'zh-hk': "Skicircus透過壯觀的環形滑雪路線，將Salzburger Land地區四個村莊連接起來，形成270km雪道、70座纜車，並以位處Salzburg與Tyrol邊界、陽光充沛而聞名。Saalbach是滑雪後派對的重量級代表，Hinterglemm是山谷深處的家庭中心，Leogang是主打滑雪公園及單車公園的姊妹村，Fieberbrunn則是自由滑雪的終點。一張滑雪證覆蓋整個環圈。",
  ...
  },
  {
    ...
    intro: {
      ...
      ja: "Schladming、Dachstein氷河、Ramsau高原を1枚の地域共通パスでカバー。Styria地方アルプスに広がる230kmのゲレンデ。",
      'zh-hk': "Schladming、Dachstein冰川及Ramsau高原共用一張地區滑雪證，230km雪道位於Styria阿爾卑斯山區。",
    ...
    description: {
      ...
      ja: "Schladming-Dachsteinエリアは、ワールドカップ開催地であるSchladmingの町（Planai・Hochwurzen・Hauser Kaibling・Reiteralmの4山からなるエリア）と、Dachstein氷河（標高2700m、5月まで積雪が安定）、そしてノルディックスキーの聖地Ramsau高原（クロスカントリーコース220km）をまとめる。約230kmのアルペンゲレンデを86基のリフトがカバーし、すべてWagrainとFilzmoosも加わるより広域のSki Amadéパスに含まれる。",
      'zh-hk': "Schladming-Dachstein地區將世界盃賽事重鎮Schladming（由Planai、Hochwurzen、Hauser Kaibling、Reiteralm四座山組成的滑雪區）、Dachstein冰川（海拔2700m，積雪穩定至五月），以及越野滑雪之都Ramsau高原（220km越野雪道）集結一起。約230km高山雪道由86座纜車服務，全部涵蓋在更廣闊的Ski Amadé滑雪證之內，同時加入Wagrain及Filzmoos。",

...
export const SEASONAL_GUIDES: SeasonalGuide[] = [
  guide(
    ...
    'val-thorens',
    {
      ...
      ja: '2026年12月、どこへ滑りに行く',
      nl: 'Waar skiën in december 2026',
      'zh-hk': '2026年12月去哪裡滑雪',
    },
  ...
  guide(
    ...
    'ischgl',
    {
      ...
      ja: '2027年2月、どこへ滑りに行く',
      nl: 'Waar skiën in februari 2027',
      'zh-hk': '2027年2月去哪裡滑雪',
    },
  ...
  guide(
    ...
    'thredbo',
    {
      ...
      ja: '2027年、南半球の冬シーズンにどこへ滑りに行く',
      nl: "Waar skiën in de winter op het zuidelijk halfrond 2027",
      'zh-hk': '2027年南半球雪季去哪裡滑雪',
    },

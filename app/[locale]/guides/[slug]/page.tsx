...
const T = {
  h1: {
    ...
    'zh-hk': (name: string, n: number) => `${name}：出發前必須知道的${n}件事`,
  ...
  metaTitle: {
    ...
    'zh-hk': (name: string) => `${name}：出發前必須知道的事`,
  } as Record<Locale, (name: string) => string>,
  whereToStay: {
    en: 'Where to stay', fr: 'Où dormir', es: 'Dónde alojarse', pt: 'Onde ficar', it: 'Dove alloggiare', nl: 'Waar te overnachten', ja: '宿泊先', 'zh-hk': '住宿推介',
  ...
  whereToStaySub: {
    ...
    'zh-hk': '我們精選滑雪出入方便、性價比高的酒店。價格僅供參考，請查看即時空房。',
  } as Record<Locale, string>,
  fullGuide: {
    en: 'Full resort guide', fr: 'Guide complet de la station', es: 'Guía completa de la estación', pt: 'Guia completo da estância', it: 'Guida completa della località', nl: 'Volledige gids van het skigebied', ja: 'リゾート完全ガイド', 'zh-hk': '滑雪場完整指南',
  } as Record<Locale, string>,
  ctaTitle: {
  ...
  ctaSub: {
    ...
    'zh-hk': '酒店、雪道詳情、逐月積雪數據、纜車及租賃資訊、地圖等等。',
  } as Record<Locale, string>,
  ctaButton: {
    ...
    'zh-hk': (name: string) => `查看${name}完整指南`,
  } as Record<Locale, (name: string) => string>,
  faqHeading: {
    en: 'More questions, answered', fr: 'Plus de questions, des réponses', es: 'Más preguntas, respondidas', pt: 'Mais perguntas, respondidas', it: 'Altre domande, con risposta', nl: 'Meer vragen, beantwoord', ja: 'その他のよくある質問', 'zh-hk': '更多問題解答',
  } as Record<Locale, string>,
  snowReport: {
    en: 'Live snow report', fr: 'Bulletin neige en direct', es: 'Parte de nieve en directo', pt: 'Boletim de neve em direto', it: 'Bollettino neve in tempo reale', nl: 'Actueel sneeuwbericht', ja: 'ライブ積雪情報', 'zh-hk': '即時積雪報告',
  } as Record<Locale, string>,
  skiInCountry: {
    en: 'Ski-in/ski-out', fr: 'Stations ski au pied', es: 'Ski-in/ski-out', pt: 'Ski-in/ski-out', it: 'Ski-in/ski-out', nl: 'Ski-in/ski-out', ja: 'ski-in/ski-out', 'zh-hk': 'ski-in/ski-out',
  } as Record<Locale, string>,
  ratingsNote: {
    ...
    'zh-hk': '評分及評論數量來自Google Places。我們可能從預訂中賺取佣金。',
  } as Record<Locale, string>,
}

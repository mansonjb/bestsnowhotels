...
const REASON: Record<'champion' | 'gentle' | 'beginner' | 'carfree' | 'sio' | 'tagged', Record<Locale, string>> = {
  champion: { en: 'Renowned for families', fr: 'Référence en famille', es: 'Referente familiar', pt: 'Referência em família', it: 'Icona per le famiglie', nl: 'Bekend bij gezinnen' },
  gentle: { en: 'Gentle slopes', fr: 'Pentes douces', es: 'Pistas suaves', pt: 'Pistas suaves', it: 'Piste dolci', nl: 'Zachte hellingen' },
  beginner: { en: 'Real beginner runs', fr: 'Vraies pistes débutants', es: 'Pistas para principiantes', pt: 'Pistas para principiantes', it: 'Piste per principianti', nl: 'Echte beginnerspistes' },
  carfree: { en: 'Car-free village', fr: 'Village sans voitures', es: 'Pueblo sin coches', pt: 'Aldeia sem carros', it: 'Borgo senza auto', nl: 'Autovrij dorp' },
  sio: { en: 'Ski-in/ski-out', fr: 'Ski au pied', es: 'A pie de pista', pt: 'À beira das pistas', it: 'Sci ai piedi', nl: 'Ski-in/ski-out' },
  tagged: { en: 'Family favourite', fr: 'Valeur sûre en famille', es: 'Ideal en familia', pt: 'Ideal em família', it: 'Perfetta per famiglie', nl: 'Favoriet bij gezinnen' },
}
...
const T = {
  ...
  guide: { en: 'Resort guide', fr: 'Guide de la station', es: 'Guía de la estación', pt: 'Guia da estância', it: 'Guida della località', nl: 'Gids van het skigebied' } as Record<Locale, string>,
  book: { en: 'Find a family hotel', fr: 'Trouver un hôtel familial', es: 'Buscar un hotel familiar', pt: 'Encontrar um hotel familiar', it: 'Trova un hotel per famiglie', nl: 'Zoek een gezinshotel' } as Record<Locale, string>,
  mapTitle: { en: 'Family hotels around', fr: 'Hôtels familiaux autour de', es: 'Hoteles familiares en torno a', pt: 'Hotéis familiares em redor de', it: 'Hotel per famiglie intorno a', nl: 'Gezinshotels rond' } as Record<Locale, string>,
  more: { en: 'Keep planning', fr: 'Continuer à préparer', es: 'Sigue planificando', pt: 'Continue a planear', it: 'Continua a pianificare', nl: 'Verder plannen' } as Record<Locale, string>,
  allCountries: { en: 'Family skiing by country', fr: 'Ski en famille par pays', es: 'Esquí en familia por país', pt: 'Esqui em família por país', it: 'Sci in famiglia per paese', nl: 'Skien met het gezin per land' } as Record<Locale, string>,
  europeList: { en: 'Best family resorts in Europe', fr: "Meilleures stations familiales d'Europe", es: 'Mejores estaciones familiares de Europa', pt: 'Melhores estâncias familiares da Europa', it: "Migliori località per famiglie d'Europa", nl: 'Beste skigebieden voor gezinnen in Europa' } as Record<Locale, string>,
  faqTitle: { en: 'Family skiing questions', fr: 'Questions ski en famille', es: 'Preguntas sobre esquí en familia', pt: 'Perguntas sobre esqui em família', it: 'Domande sullo sci in famiglia', nl: 'Vragen over skien met het gezin' } as Record<Locale, string>,
}

...
export async function generateMetadata({
  ...
  const descriptions: Record<Locale, string> = {
    en: 'Find ski-in/ski-out hotels across 136 resorts in France, Switzerland, Austria, Italy, Spain and Andorra. Real altitudes, real snow data, best prices.',
    fr: 'Trouvez des hôtels ski-in/ski-out dans 136 stations en France, en Suisse, en Autriche, en Italie, en Espagne et en Andorre. Altitudes réelles, données d\'enneigement, meilleurs prix.',
    es: 'Encuentra hoteles ski-in/ski-out en 136 estaciones de Francia, Suiza, Austria, Italia, España y Andorra. Altitudes reales, datos de nieve, los mejores precios.',
    pt: 'Encontre hotéis ski-in/ski-out em 136 estâncias em França, na Suíça, na Áustria, em Itália, em Espanha e em Andorra. Altitudes reais, dados de neve, os melhores preços.',
  }

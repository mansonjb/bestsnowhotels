...
export async function generateMetadata({
  ...
  const descriptions: Record<Locale, string> = {
    en: 'Find ski-in/ski-out hotels across 327 resorts in France, Switzerland, Austria, Italy, Spain, Andorra, Germany, Norway, Sweden and Finland. Real altitudes, real snow data, best prices.',
    fr: 'Trouvez des hôtels ski-in/ski-out dans 327 stations en France, en Suisse, en Autriche, en Italie, en Espagne, en Andorre, en Allemagne, en Norvège, en Suède et en Finlande. Altitudes réelles, données d\'enneigement, meilleurs prix.',
    es: 'Encuentra hoteles ski-in/ski-out en 327 estaciones de Francia, Suiza, Austria, Italia, España, Andorra, Alemania, Noruega, Suecia y Finlandia. Altitudes reales, datos de nieve, los mejores precios.',
    pt: 'Encontre hotéis ski-in/ski-out em 327 estâncias em França, na Suíça, na Áustria, em Itália, em Espanha, em Andorra, na Alemanha, na Noruega, na Suécia e na Finlândia. Altitudes reais, dados de neve, os melhores preços.',
    it: 'Trova hotel ski-in/ski-out in 327 località tra Francia, Svizzera, Austria, Italia, Spagna, Andorra, Germania, Norvegia, Svezia e Finlandia. Quote reali, dati neve veri, prezzi migliori.',
  }

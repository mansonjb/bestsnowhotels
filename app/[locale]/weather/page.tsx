      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-white border border-ice-200 text-slate-deep font-semibold px-5 py-2.5 rounded-full hover:border-ice-400 transition text-sm"
          >
            🌍 {({ en: 'Where is it snowing now?', fr: 'Où neige-t-il en ce moment ?', es: '¿Dónde está nevando ahora?', pt: 'Onde está a nevar agora?', it: 'Dove sta nevicando ora?', nl: 'Waar sneeuwt het nu?', ja: '今、雪が降っているのはどこ？', 'zh-hk': '現在哪裡正在下雪？' } as Record<Locale, string>)[l]}
          </Link>
        </div>
      </section>

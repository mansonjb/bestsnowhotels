...
const COPY: Record<Locale, { title: string; paragraphs: string[] }> = {
  ...
  fr: {
    ...
    paragraphs: [
      ...
      'Nous couvrons 92 stations en France, en Suisse, en Autriche, en Italie, en Espagne et en Andorre. Pour chacune, nous indiquons les altitudes vérifiées, les kilomètres de pistes, les dates de saison et une note ski-in/ski-out transparente. La carte interactive de chaque destination est fournie par Stay22. Elle compare Booking, Expedia et Hotels.com en temps réel, vous voyez donc toujours le meilleur prix.',
  ...
  es: {
    ...
    paragraphs: [
      ...
      'Cubrimos 92 estaciones en Francia, Suiza, Austria, Italia, España y Andorra. Para cada una indicamos las altitudes verificadas, los kilómetros de pistas, las fechas de temporada y una nota ski-in/ski-out transparente. El mapa interactivo de cada destino lo proporciona Stay22. Compara Booking, Expedia y Hotels.com en tiempo real, así que siempre ves el mejor precio.',

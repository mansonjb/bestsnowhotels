...
const COPY: Record<Locale, { title: string; paragraphs: string[] }> = {
  ...
  fr: {
    ...
    paragraphs: [
      ...
      'Nous couvrons 327 stations en France, en Suisse, en Autriche, en Italie, en Espagne, en Andorre, en Allemagne, en Norvège, en Suède et en Finlande. Pour chacune, nous indiquons les altitudes vérifiées, les kilomètres de pistes, les dates de saison et une note ski-in/ski-out transparente. La carte interactive de chaque destination est fournie par Stay22. Elle compare Booking, Expedia et Hotels.com en temps réel, vous voyez donc toujours le meilleur prix.',
  ...
  es: {
    ...
    paragraphs: [
      ...
      'Cubrimos 327 estaciones en Francia, Suiza, Austria, Italia, España, Andorra, Alemania, Noruega, Suecia y Finlandia. Para cada una indicamos las altitudes verificadas, los kilómetros de pistas, las fechas de temporada y una nota ski-in/ski-out transparente. El mapa interactivo de cada destino lo proporciona Stay22. Compara Booking, Expedia y Hotels.com en tiempo real, así que siempre ves el mejor precio.',
  ...
  it: {
    ...
    paragraphs: [
      ...
      'Copriamo 327 località in Francia, Svizzera, Austria, Italia, Spagna, Andorra, Germania, Norvegia, Svezia e Finlandia. Per ognuna indichiamo quote verificate, chilometri di piste, date di stagione e una nota ski-in/ski-out trasparente. La mappa interattiva di ogni destinazione è fornita da Stay22. Confronta Booking, Expedia e Hotels.com in tempo reale, così vedi sempre il miglior prezzo.',

...
const COPY: Record<Locale, { title: string; paragraphs: string[] }> = {
  ...
  pt: {
    ...
    paragraphs: [
      ...
      'Cobrimos 407 estâncias em França, na Suíça, na Áustria, em Itália, em Espanha, em Andorra, na Alemanha, na Noruega, na Suécia, na Finlândia, no Japão, nos Estados Unidos, em Marrocos, na Argélia, no Lesoto, na África do Sul, no Egito, no Canadá, na Coreia do Sul, na Austrália, na Nova Zelândia e no Chile. Para cada uma indicamos as altitudes verificadas, os quilómetros de pistas, as datas da época e uma nota ski-in/ski-out transparente. O mapa interativo de cada destino é fornecido pelo Stay22. Compara Booking, Expedia e Hotels.com em tempo real, por isso vê sempre o melhor preço.',
  ...
  it: {
    ...
    paragraphs: [
      ...
      'Copriamo 407 località in Francia, Svizzera, Austria, Italia, Spagna, Andorra, Germania, Norvegia, Svezia, Finlandia, Giappone, Stati Uniti, Marocco, Algeria, Lesotho, Sudafrica, Egitto, Canada, Corea del Sud, Australia, Nuova Zelanda e Cile. Per ognuna indichiamo quote verificate, chilometri di piste, date di stagione e una nota ski-in/ski-out trasparente. La mappa interattiva di ogni destinazione è fornita da Stay22. Confronta Booking, Expedia e Hotels.com in tempo reale, così vedi sempre il miglior prezzo.',

...
const T = {
  metaTitle: {
    ...
    'zh-hk': "2026年安第斯山脈：僅餘最後幾星期可滑雪，立即預訂",
  ...
  intro: {
    ...
    'zh-hk': "2026年安第斯山脈雪季將於九月下旬至十月下旬閉幕。智利與阿根廷的高地仍有深厚積雪。以下為你介紹營業時間最長、雪況最佳的滑雪場，以及雪季結束前預訂酒店的方法。",
  } as Record<Locale, string>,
  urgency: {
    ...
    'zh-hk': "立即預訂：Portillo及Las Leñas將率先於九月底結束營業。地勢較高的Valle Nevado、Nevados de Chillan、Corralco及Pucon雪季則持續至十月。",
  } as Record<Locale, string>,
  openUntil: {
    en: "Open until", fr: "Ouvert jusqu'au", es: "Abierto hasta", pt: "Aberto ate", it: "Aperto fino al", nl: "Open tot", ja: "営業終了日", 'zh-hk': "營業至",
  } as Record<Locale, string>,
  book: { en: "Book hotels", fr: "Reserver un hotel", es: "Reservar hoteles", pt: "Reservar hoteis", it: "Prenota hotel", nl: "Boek hotels", ja: "ホテルを予約", 'zh-hk': "預訂酒店" } as Record<Locale, string>,
  report: { en: "Snow report", fr: "Bulletin neige", es: "Parte de nieve", pt: "Boletim de neve", it: "Bollettino neve", nl: "Sneeuwbericht", ja: "積雪情報", 'zh-hk': "積雪報告" } as Record<Locale, string>,
  resortsTitle: {
